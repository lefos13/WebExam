...
<html lang="en">
  <head>
    ...
    <script>
        function show(){
            var centerid = document.getElementById("examc").value;
            ...
            xhttp.open("GET", "ajax_cdate.jsp?centerid="+centerid, true);
            xhttp.send();
            
        }
        
        function final(){
            var testid = document.getElementById("date").value;
            var xhttp = new XMLHttpRequest();
            ...
            xhttp.open("GET", "ajax_finalec.jsp?testid="+testid, true);
            xhttp.send();
          ...
          <div class="jumbotron">
              <div id="main">
                  <div class="form-group">
                      ...
                      <select id="examc" class="form-control">
                          <%
                                 ...
                                 { // Walk through the Array.
                                            ...
                                            %>
                                            <option value="<%out.println(obj.getString("id"));%>"><%out.println(obj.getString("name"));%></option>
                                            <%
                                 }     
                           %>
                      </select>
