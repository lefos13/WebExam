...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div>
          <div class="jumbotron">                      
              <h3><a class="btn btn-primary" href="reports/resultsexam.jsp">Results based on exam id</a> <br> <h3>
              <h3><a class="btn btn-primary" href="reports/resultsexamc.jsp">Results based on exam center</a> <br> <h3>
              <h3><a class="btn btn-primary" href="reports/resultsallexams.jsp">Results of all exams</a> <br> <h3>
              <h3><a class="btn btn-primary" href="reports/resultsexaminee.jsp">Results of a specific examinee</a> <br> <h3>        
          </div>
