...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
               ...
               else if(type.equals("admin_c"))
               {
                    %>
                   <li><a href="startexam.jsp">Start exam procedure</a></li>
                   <li><a href="adduser.jsp">Add user to an exam</a></li>
                   <li><a href="reports.jsp">Reports</a></li>
                   <%
               }
      ...
      <div>
          <% if(type.equals("admin_s"))
          {
              %>
              <div class="jumbotron">
                <h1>Add Admin Center</h1>
                <form action="addac_code.jsp" method="post">
                ...
                <div class="form-group">
                    <label for="Exam Center Id">Exam Center id</label>
                    <input type="text" class="form-control" id="examid" name="examid" placeholder="Exam Center id">
                </div>
